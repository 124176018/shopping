...
<body style="position:relative;">
    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
            	<li class="per-li2"><a href="${pageContext.request.contextPath}/user/personaldata.do">个人资料<span></span></a></li>
            	<li class="per-li3"><a href="${pageContext.request.contextPath}/order/myOrders.do?pageNow=${allProduct.pageNow}&uid=${su.uid}">我的订单<span>></span></a></li>
    	...
    	<div class="order-right f-r">
        	<div class="order-hd">
            	<dl class="f-l">
                	<dt>
                    	<a href="${pageContext.request.contextPath}/#"><img src="${pageContext.request.contextPath}/images/data-tu2.gif" /></a>
                    </dt>
                    <dd>
                ...
                <c:forEach items="${pageBenForOrder.list}" var="orderExt">
                    ...
                    <div class="md-info">
                        ...
                        <div class="dai-con">
                            <dl class="dl1">
                                <dt>
                                    <a href="#" class="f-l"><img src="http://localhost:80/manager/${orderitem.product.pimage}" width="82px" height="82px"/></a>
                                    <div style="clear:both;"></div>
                                </dt>
                                <dd>
                            ...
                            <div class="dai-right f-l" style="margin-top: 50px">
                                ...
                                <p class="d-r-p3">
                                    <c:if test="${orderExt.state==0}" ><span> <a href="${pageContext.request.contextPath}/order/gotopay.do?oid=${orderExt.oid}">去付款</a></span> </c:if>
                                    <c:if test="${orderExt.state==1}" ><span id="ysh"> <a href="JavaScript:" onclick="yishouhuo(${orderExt.oid})">提醒发货</a></span> </c:if>
                                    <c:if test="${orderExt.state==2}" ><span id="qrsh"> <a href="JavaScript:" onclick="confirmproduct(${orderExt.oid})">确认收货</a></span> </c:if>
                ...
                <div class="paging">
                    <div class="pag-left f-l">
                        <c:if test="${pageBenForOrder.pageNow!=1}">
                            <a href="${pageContext.request.contextPath}/order/myOrders.do?pageNow=${pageBenForOrder.pageNow-1}&uid=${su.uid}" class="about left-r f-l">«</a>
                        </c:if>
                        <ul class="left-m f-l">
                            ...
                            <c:forEach var="i" begin="${begin}" end="${end}">
                                ...
                                <c:choose>
                                    <c:when test="${i == pageBenForOrder.pageNow}">
                                        <li class="active"><a href="${pageContext.request.contextPath}/order/myOrders.do?uid=${su.uid}&pageNow=${i}" class="about left-r f-l">${i}</a></li>
                                    </c:when>
                                    <%--不是当前页--%>
                                    <c:otherwise>
                                        <li><a href="${pageContext.request.contextPath}/order/myOrders.do?pageNow=${i}&uid=${su.uid}" class="about left-r f-l">${i}</a></li>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                            ...
                            <c:if test="${pageBenForOrder.pageNow != 1}">
                                <c:choose>
                                    <c:when test="${pageBenForOrder.pageNow == 1}">
                                        <li class="disabled">
                                            <a href="${pageContext.request.contextPath}/order/myOrders.do?uid=${su.uid}&pageNow=1" class="about left-r f-l" aria-label="Previous">
                            ...
                            <c:if test="${pageBenForOrder.pageNow != pageBenForOrder.pageCount}">
                                <c:choose>
                                    <c:when test="${pageBenForOrder.pageNow == pageBenForOrder.pageCount}">
                                        <li class="disabled">
                                            <a href="${pageContext.request.contextPath}/order/myOrders.do?uid=${su.uid}&pageNow=${pageBenForOrder.pageCount}" class="about left-r f-l" aria-label="Previous">
                                    ...
                                    <c:otherwise>
                                        <%-- 点击到尾页--%>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/order/myOrders.do?uid=${su.uid}&pageNow=${pageBenForOrder.pageCount}" class="about left-r f-l" aria-label="Next">
                                                <span aria-hidden="true">尾页</span>
                                            </a>
                                        </li>
                                    </c:otherwise>
                        ...
                        <c:if test="${pageBenForOrder.pageNow!=pageBenForOrder.pageCount}">
                            <a href="${pageContext.request.contextPath}/order/myOrders.do?uid=${su.uid}&pageNow=${pageBenForOrder.pageNow+1}" class="about left-l f-l">»</a>
                        </c:if>
                        <div style="clear:both;"></div>
                    </div>
