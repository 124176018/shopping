...
<div class="zl-info w1200">
    ...
    <div class="zl-con">
        <div class="zl-con-left f-l">
            ...
            <ul class="zl-lhover">
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">饼干糕点</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">厨房调味</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">厨房清洁</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">洗浴用品</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">宝宝喂养</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">家居彩电</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">宝宝喂养</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">家居彩电</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">厨房清洁</a></li>
                <li><a href="${pageContext.request.contextPath}/搜索列表(有品牌).html">洗浴用品</a></li>
        ...
        <div class="zl-con-right f-l">
            <div class="zl-rbox lihover">
                <div class="rbox-left f-l">
                    ...
                    <ul class="rbox-lft">
                        <li>
                            ...
                            <p>￥25.00/袋</p>
                            <a href="${pageContext.request.contextPath}/商品详情.html" class="a2"><img src="${pageContext.request.contextPath}/images/zl2-46.gif" /></a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/商品详情.html" class="a1">特产中国山西大枣</a>
                            <p>￥25.00/袋</p>
                            <a href="${pageContext.request.contextPath}/商品详情.html" class="a2"><img src="${pageContext.request.contextPath}/images/zl2-44.gif" /></a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/商品详情.html" class="a1">Wonderful 盐焗开心果</a>
                            <p>￥39.00/袋</p>
                            <a href="${pageContext.request.contextPath}/商品详情.html" class="a2"><img src="${pageContext.request.contextPath}/images/zl2-45.gif" /></a>
                        </li>
                        <div style="clear:both;"></div>
                    </ul>
                </div>
                <ul class="rbox-right f-l">
                    <li>
                        <a href="${pageContext.request.contextPath}/商品详情.html" class="a1">人头马XO香槟干邑白兰地</a>
                        <p>￥1950.00/件</p>
                        <a href="${pageContext.request.contextPath}/商品详情.html" class="a2"><img src="${pageContext.request.contextPath}/images/zl2-47.gif" /></a>
                    </li>
                    <li>
        ...
        <div class="zl-con-right f-l">
            ...
            <ul class="zl-rul1 lihover">
                ...
                <li>
                    ...
                    <div class="sy-tit2">
                        <p><a href="${pageContext.request.contextPath}/">都市新大新特色豆米锅</a></p>
                        <p>地址：渝中区石油路174号龙湖时代天A馆L3-20</p>
                        <p>电话：023-63310530</p>
                    </div>
                </li>
