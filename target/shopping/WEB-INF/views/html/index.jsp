                        ...
                        <div class="kuaijie-con">
                            <c:forEach items="${lmo.categorysSeconds}" var="lmoo">
                                <dl class="kj-dl2" style="display:inline-block">
                                    <dt>
                                        <a href="${pageContext.request.contextPath}/cate/doproducts.do?csid=${lmoo.csid}">${lmoo.csname}</a>
                                    </dt>
                                </dl>
                            </c:forEach>
                            <div style="clear:both;"></div>
...
<div class="banner">
    <ul class="ban-ul1">
        <li><a href="${pageContext.request.contextPath}/JavaScript:;"><img
                src="${pageContext.request.contextPath}/images/banner.png"/></a></li>
        <li><a href="${pageContext.request.contextPath}/JavaScript:;"><img
                src="${pageContext.request.contextPath}/images/banner.png"/></a></li>
        <li><a href="${pageContext.request.contextPath}/JavaScript:;"><img
                src="${pageContext.request.contextPath}/images/banner.png"/></a></li>
            ...
            <div class="zl-con-left f-l" style="background:#FBEAD0;">
                ...
                <ul class="zl-lhover" style=" background:#FF9A02;">
                    <c:forEach items="${louceng.categorysSeconds}" var="louceng1">
                        <li>
                            <a href="${pageContext.request.contextPath}/cate/doproducts.do?csid=${louceng1.csid}">${louceng1.csname}</a>
                        </li>
                    </c:forEach>
                    <div style="clear:both;"></div>
                </ul>
            ...
            <div class="zl-con-right f-l">
                <ul class="zl-rul1 lihover">
                    <c:forEach items="${louceng.categorysSeconds}" var="louceng2">
                        <li>
                            <div class="sy-tu1">
                                <a href="${pageContext.request.contextPath}/cate/doproducts.do?csid=${louceng2.csid}"><img
                                        src="${pageContext.request.contextPath}/images/zl2-84.png"/></a>
                            </div>
                            <div class="sy-tit1">
