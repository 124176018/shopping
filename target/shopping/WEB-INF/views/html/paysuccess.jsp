...
<div class="payment w1200">
    ...
    <c:forEach items="${ordersExt.orderitemExtList}" var="orderitem">
        <div class="payment-bd">
            <dl class="dl-hd">
                <dt><img src="http://localhost:80/manager/${orderitem.product.pimage}" width="123" height="122"/></dt>
                <dd>
            ...
            <ul class="ul-bd">
                <li><span>包邮</span>
                    <p></p></li>
                <li><span>价格</span>
                    <p><i>¥${orderitem.subtotal}</i></p></li>
                <li><span>收货信息</span>
                    <p>${ordersExt.addr}-${ordersExt.name}-${ordersExt.phone}</p></li>
                <li><span>成交时间</span>
                    <p>${ordersExt.ordertime}</p></li>
                <li><span>订单号</span>
                    <p>${ordersExt.oid}</p></li>
            </ul>
        </div>
    </c:forEach>
