...
<div class="cart-content w1200">
    ...
    <div class="cart-con-info" id="re">
        <form action="${pageContext.request.contextPath}/order/getOder.do" method="post" id="biaodan"
              onsubmit="return jiesuan1()">
            ...
            <div class="info-mid">
                ...
                <div class="mid-tu f-l">
                    <a href="#"><img src="http://localhost:80/manager/${gw.product.pimage}" width="100"
                                     height="100"/></a>
                </div>
