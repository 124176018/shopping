        ...
        <form action="${pageContext.request.contextPath}/cart/addCartItem.do" method="post">
            <ul class="sp-info-r m-act beaut">
                ...
                <li style="border-bottom:0; border-right:0;">
                    <div class="li-top">
                        <a href="${pageContext.request.contextPath}/cate/pdproducts.do?pid=${ld.pid}" class="li-top-tu"><img
                                src="http://localhost:80/manager/${ld.pimage}" width="200" height="200"/></a>
                    ...
                    <div class="li-md">
                        <div class="md-l f-l">
                            <input type="number" id="proCount${ld.pid}" name="proCount" value="1" class="md-l-l f-l"
                                   ap="" min="1">
                            <div style="clear:both;"></div>
                        </div>
        ...
        <div class="paging">
            <div class="pag-left f-l">
                <c:if test="${allProduct.pageNow!=1}">
                    <a href="${pageContext.request.contextPath}/cate/doproducts.do?cid=${allProduct.cid}&csid=${allProduct.csid}&pname=${allProduct.pname}&pageNow=${allProduct.pageNow-1}"
                    ...
                    <c:forEach var="i" begin="${begin}" end="${end}">
                        ...
                        <c:choose>
                            <c:when test="${i == allProduct.pageNow}">
                                <li class="active"><a
                                        href="${pageContext.request.contextPath}/cate/doproducts.do?cid=${allProduct.cid}&csid=${allProduct.csid}&pname=${allProduct.pname}&pageNow=${i}"
                                        class="about left-r f-l">${i}</a></li>
                            </c:when>
                            <%--不是当前页--%>
                            <c:otherwise>
                                <li>
                                    <a href="${pageContext.request.contextPath}/cate/doproducts.do?cid=${allProduct.cid}&csid=${allProduct.csid}&pname=${allProduct.pname}&pageNow=${i}"
                                       class="about left-r f-l">${i}</a></li>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    ...
                    <c:if test="${allProduct.pageNow != 1}">
                        <c:choose>
                            <c:when test="${allProduct.pageNow == 1}">
                                <li class="disabled">
                                    <a href="${pageContext.request.contextPath}/cate/doproducts.do?cid=${allProduct.cid}&csid=${allProduct.csid}&pname=${allProduct.pname}&pageNow=1"
                    ...
                    <c:if test="${allProduct.pageNow != allProduct.pageCount}">
                        <c:choose>
                            <c:when test="${allProduct.pageNow == allProduct.pageCount}">
                                <li class="disabled">
                                    <a href="${pageContext.request.contextPath}/cate/doproducts.do?cid=${allProduct.cid}&csid=${allProduct.csid}&pname=${allProduct.pname}&pageNow=${allProduct.pageCount}"
                                       class="about left-r f-l" aria-label="Previous">
            ...
            <form action="${pageContext.request.contextPath}/cate/doproducts.do?cid=${allProduct.cid}&csid=${allProduct.csid}&pname=${allProduct.pname}"
                  method="post">
